  ...
  return (
    <main className="flex justify-center items-center mt-20">
      <div className="w-96 my-shadow bg-[#2B6AD0] text-white text-center rounded-xl p-8 border-2 border-[#2B6AD0]">
        ...
        <h1 className="font-extrabold text-2xl mt-1 mb-6">Sign Up</h1>
        <form>
            ...
            <input id="password_confirmation" className="mt-4 py-2 px-16 rounded-md text-center text-[#7C7C7C]" type="password" placeholder='Password Confirmation' name="password_confirmation" onChange={handleChange} value={formData.password_confirmation} />   
